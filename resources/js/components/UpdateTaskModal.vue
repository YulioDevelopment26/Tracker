          ...
          <div class="flex justify-around space-x-4">
            ...
            <div>
              ...
              <select
                ...
                :disabled="isLocked('priority')"
                :class="['border h-9 border-gray-300 rounded bg-white px-2', lockedClass('priority')]"
              >
            ...
            <div>
              ...
              <select
                ...
                :class="['border h-9 border-gray-300 rounded bg-white px-2', lockedClass('category')]"
              >
          ...
          <div class="flex justify-around space-x-4">
            <div>
              ...
              <Input
                ...
                :min="props.sprint.start_date.split('T')[0]"
                :max="props.sprint.end_date.split('T')[0]"
                :readonly="isLocked('actual_start')"
            ...
            <div>
              ...
              <Input
                ...
                :max="props.sprint.end_date.split('T')[0]"
                :readonly="isLocked('actual_finish')"
